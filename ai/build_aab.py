...
with zipfile.ZipFile(aab_path, 'w', zipfile.ZIP_DEFLATED) as zipf:
    ...
    zipf.writestr('BundleConfig.pb', b'SKIL Lifestyle Android App Bundle v1.0.2 Target SDK 36 Package com.skil.app')
    ...
    zipf.writestr('BUNDLE-METADATA/com.android.tools.build.libraries/dependencies.pb', b'com.skil.app:1.0.2')
